                ...
                <div className="App">
                    ...
                    <PageContainer bgColor='#4E83EB'>
                        ...
                        <AnimatedText delay={500}>
                            <p>I'm a senior at BASIS Phoenix trying to make coding accessible to everybody!</p>
                        </AnimatedText>
                        <AnimatedText delay={750}>
                            <p>I'm passionate about education and its effects on inequality.</p>
                        </AnimatedText>
                        <AnimatedText delay={1000}>
                            <p>
                                Most of my time goes towards programming and business development for my company <a href="www.gocode.courses">GoCode</a>.
                            </p>
                        </AnimatedText>
                        <AnimatedText delay={1250}>
                            <p>In my free time I do freelance web/mobile app development.</p>
                        </AnimatedText>
                    </PageContainer>
